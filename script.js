...
loginForm.addEventListener('submit', function (event) {
    ...
    if (user) {
        ...
        window.location.href = 'https://svetlanaforte-2000.github.io/new-my-shop/user-account.html'; // Перенаправлення на сторінку особистого кабінету
    } else {
...
document.getElementById('checkout-button').addEventListener('click', function() {
    window.location.href = 'https://svetlanaforte-2000.github.io/new-my-shop/checkout.html';
});
